...
const TRPC_TARGET =
  ...
  'https://opsqnzswjxzvywvqjvjv.functions.supabase.co/tapse-backend/trpc';

const allowedOrigins = [
  'https://tapse.netlify.app',
  'http://localhost:3000',
  'https://opsqnzswjxzvywvqjvjv.supabase.co',
  'https://opsqnzswjxzvywvqjvjv.functions.supabase.co',
];
