...
export default function MenuScreen() {
  ...
  const ratingsStatsQuery = trpc.ratings.getAllStats.useQuery(undefined, { staleTime: 5 * 60 * 1000 });
  ...
  }, [getItemDescription, getItemName, menuItems, searchQuery, selectedCategory]);
